...
namespace Ambermoon.Editor.Gui.Editors {
  partial class EditItemForm {
    ...
    private void InitializeComponent() {
      ...
      cbxAmmunitionType = new ComboBox();
      label7 = new Label();
      cbxGender = new ComboBox();
      label3 = new Label();
      label2 = new Label();
      cbxSpell = new ComboBox();
      pbxGraphic = new ExtendedPictureBox();
      grbxFlags = new GroupBox();
      chbxItemFlagsStackable = new CheckBox();
      chbxItemFlagsDestroyAfterUsage = new CheckBox();
      chbxItemFlagsIndestructible = new CheckBox();
      chbxItemFlagsAccursed = new CheckBox();
      chbxItemFlagsNone = new CheckBox();
      chbxItemFlagsRemovableDuringFight = new CheckBox();
      chbxItemFlagsCloneable = new CheckBox();
      chbxItemFlagsNotImportant = new CheckBox();
      grbxDefaultSlotFlags = new GroupBox();
      chbxDefaultSlotFlagCursed = new CheckBox();
      chbxDefaultSlotFlagIdentified = new CheckBox();
      chbxDefaultSlotFlagLocked = new CheckBox();
      chbxDefaultSlotFlagBroken = new CheckBox();
      chbxDefaultSlotFlagNone = new CheckBox();
      grbxClasses = new GroupBox();
      chbxClassesAllWithUnused = new CheckBox();
      chbxClassesAll = new CheckBox();
      chbxClassesUnused2 = new CheckBox();
      chbxClassesMystic = new CheckBox();
      chbxClassesUnused3 = new CheckBox();
      chbxClassesHealer = new CheckBox();
      chbxClassesUnused4 = new CheckBox();
      chbxClassesAlchemist = new CheckBox();
      chbxClassesMonster = new CheckBox();
      chbxClassesRanger = new CheckBox();
      chbxClassesWarrior = new CheckBox();
      chbxClassesMage = new CheckBox();
      chbxClassesAdventurer = new CheckBox();
      chbxClassesAnimal = new CheckBox();
      chbxClassesThief = new CheckBox();
      ...
      label30 = new Label();
      nudMaxRecharges = new NumericUpDown();
      label23 = new Label();
      ...
      nudWeight.Value = new decimal(new int[] { 100, 0, 0, 0 });
      // 
      // cbxType
      // 
      ...
      nudSkill.Value = new decimal(new int[] { 100, 0, 0, 0 });
      // 
      // nudAttribute
      // 
      ...
      nudAttribute.Value = new decimal(new int[] { 100, 0, 0, 0 });
      // 
      // cbxAmmunitionType
      // 
      ...
      // grbxFlags
      // 
      grbxFlags.Controls.Add(chbxItemFlagsStackable);
      grbxFlags.Controls.Add(chbxItemFlagsDestroyAfterUsage);
      grbxFlags.Controls.Add(chbxItemFlagsIndestructible);
      grbxFlags.Controls.Add(chbxItemFlagsAccursed);
      grbxFlags.Controls.Add(chbxItemFlagsNone);
      grbxFlags.Controls.Add(chbxItemFlagsRemovableDuringFight);
      ...
      chbxItemFlagsStackable.Text = "Stackable";
      chbxItemFlagsStackable.UseVisualStyleBackColor = true;
      // 
      // chbxItemFlagsDestroyAfterUsage
      // 
      ...
      chbxItemFlagsDestroyAfterUsage.Text = "Destroy After Usage";
      chbxItemFlagsDestroyAfterUsage.UseVisualStyleBackColor = true;
      // 
      // chbxItemFlagsIndestructible
      // 
      ...
      chbxItemFlagsIndestructible.Text = "Indestructible";
      chbxItemFlagsIndestructible.UseVisualStyleBackColor = true;
      // 
      // chbxItemFlagsAccursed
      // 
      ...
      chbxItemFlagsAccursed.Text = "Accursed";
      chbxItemFlagsAccursed.UseVisualStyleBackColor = true;
      // 
      // chbxItemFlagsNone
      // 
      chbxItemFlagsNone.AutoSize = true;
      chbxItemFlagsNone.Font = new Font("Segoe UI", 9F);
      chbxItemFlagsNone.Location = new Point(6, 22);
      chbxItemFlagsNone.Name = "chbxItemFlagsNone";
      chbxItemFlagsNone.Size = new System.Drawing.Size(55, 19);
      chbxItemFlagsNone.TabIndex = 0;
      chbxItemFlagsNone.Text = "None";
      chbxItemFlagsNone.UseVisualStyleBackColor = true;
      // 
      // chbxItemFlagsRemovableDuringFight
      // 
      ...
      chbxItemFlagsRemovableDuringFight.Text = "Removeable During Fight";
      chbxItemFlagsRemovableDuringFight.UseVisualStyleBackColor = true;
      // 
      // chbxItemFlagsCloneable
      // 
      ...
      chbxItemFlagsCloneable.Text = "Cloneable";
      chbxItemFlagsCloneable.UseVisualStyleBackColor = true;
      // 
      // chbxItemFlagsNotImportant
      // 
      ...
      chbxItemFlagsNotImportant.Text = "Not Important";
      chbxItemFlagsNotImportant.UseVisualStyleBackColor = true;
      // 
      // grbxDefaultSlotFlags
      // 
      grbxDefaultSlotFlags.Controls.Add(chbxDefaultSlotFlagCursed);
      grbxDefaultSlotFlags.Controls.Add(chbxDefaultSlotFlagIdentified);
      grbxDefaultSlotFlags.Controls.Add(chbxDefaultSlotFlagLocked);
      ...
      chbxDefaultSlotFlagCursed.Text = "Cursed";
      chbxDefaultSlotFlagCursed.UseVisualStyleBackColor = true;
      // 
      // chbxDefaultSlotFlagIdentified
      // 
      ...
      chbxDefaultSlotFlagIdentified.Text = "Identified";
      chbxDefaultSlotFlagIdentified.UseVisualStyleBackColor = true;
      // 
      // chbxDefaultSlotFlagLocked
      // 
      ...
      chbxDefaultSlotFlagLocked.Text = "Locked";
      chbxDefaultSlotFlagLocked.UseVisualStyleBackColor = true;
      // 
      // chbxDefaultSlotFlagBroken
      // 
      ...
      chbxDefaultSlotFlagBroken.Text = "Broken";
      chbxDefaultSlotFlagBroken.UseVisualStyleBackColor = true;
      // 
      // chbxDefaultSlotFlagNone
      // 
      chbxDefaultSlotFlagNone.AutoSize = true;
      chbxDefaultSlotFlagNone.Font = new Font("Segoe UI", 9F);
      chbxDefaultSlotFlagNone.Location = new Point(6, 22);
      chbxDefaultSlotFlagNone.Name = "chbxDefaultSlotFlagNone";
      chbxDefaultSlotFlagNone.Size = new System.Drawing.Size(55, 19);
      chbxDefaultSlotFlagNone.TabIndex = 0;
      chbxDefaultSlotFlagNone.Text = "None";
      chbxDefaultSlotFlagNone.UseVisualStyleBackColor = true;
      // 
      // grbxClasses
      // 
      grbxClasses.Controls.Add(chbxClassesAllWithUnused);
      grbxClasses.Controls.Add(chbxClassesAll);
      grbxClasses.Controls.Add(chbxClassesUnused2);
      grbxClasses.Controls.Add(chbxClassesMystic);
      grbxClasses.Controls.Add(chbxClassesUnused3);
      grbxClasses.Controls.Add(chbxClassesHealer);
      grbxClasses.Controls.Add(chbxClassesUnused4);
      grbxClasses.Controls.Add(chbxClassesAlchemist);
      grbxClasses.Controls.Add(chbxClassesMonster);
      grbxClasses.Controls.Add(chbxClassesRanger);
      grbxClasses.Controls.Add(chbxClassesWarrior);
      grbxClasses.Controls.Add(chbxClassesMage);
      grbxClasses.Controls.Add(chbxClassesAdventurer);
      grbxClasses.Controls.Add(chbxClassesAnimal);
      grbxClasses.Controls.Add(chbxClassesThief);
      grbxClasses.Controls.Add(chbxClassesUnused1);
      ...
      // 
      // chbxClassesAllWithUnused
      // 
      chbxClassesAllWithUnused.AutoSize = true;
      chbxClassesAllWithUnused.Font = new Font("Segoe UI", 9F);
      chbxClassesAllWithUnused.Location = new Point(6, 72);
      chbxClassesAllWithUnused.Name = "chbxClassesAllWithUnused";
      chbxClassesAllWithUnused.Size = new System.Drawing.Size(96, 19);
      chbxClassesAllWithUnused.TabIndex = 74;
      chbxClassesAllWithUnused.Text = "All && Unused";
      chbxClassesAllWithUnused.UseVisualStyleBackColor = true;
      // 
      // chbxClassesAll
      // 
      chbxClassesAll.AutoSize = true;
      chbxClassesAll.Font = new Font("Segoe UI", 9F);
      chbxClassesAll.Location = new Point(6, 47);
      chbxClassesAll.Name = "chbxClassesAll";
      chbxClassesAll.Size = new System.Drawing.Size(40, 19);
      chbxClassesAll.TabIndex = 73;
      chbxClassesAll.Text = "All";
      chbxClassesAll.UseVisualStyleBackColor = true;
      // 
      // chbxClassesUnused2
      // 
      ...
      chbxClassesUnused2.Text = "Unused2";
      chbxClassesUnused2.UseVisualStyleBackColor = true;
      // 
      // chbxClassesMystic
      // 
      chbxClassesMystic.AutoSize = true;
      chbxClassesMystic.Font = new Font("Segoe UI", 9F);
      chbxClassesMystic.Location = new Point(199, 72);
      chbxClassesMystic.Name = "chbxClassesMystic";
      chbxClassesMystic.Size = new System.Drawing.Size(61, 19);
      chbxClassesMystic.TabIndex = 50;
      chbxClassesMystic.Text = "Mystic";
      chbxClassesMystic.UseVisualStyleBackColor = true;
      // 
      // chbxClassesUnused3
      // 
      ...
      chbxClassesUnused3.Text = "Unused3";
      chbxClassesUnused3.UseVisualStyleBackColor = true;
      // 
      // chbxClassesHealer
      // 
      chbxClassesHealer.AutoSize = true;
      chbxClassesHealer.Font = new Font("Segoe UI", 9F);
      chbxClassesHealer.Location = new Point(108, 97);
      chbxClassesHealer.Name = "chbxClassesHealer";
      chbxClassesHealer.Size = new System.Drawing.Size(60, 19);
      chbxClassesHealer.TabIndex = 49;
      chbxClassesHealer.Text = "Healer";
      chbxClassesHealer.UseVisualStyleBackColor = true;
      // 
      // chbxClassesUnused4
      // 
      ...
      chbxClassesUnused4.Text = "Unused4";
      chbxClassesUnused4.UseVisualStyleBackColor = true;
      // 
      // chbxClassesAlchemist
      // 
      chbxClassesAlchemist.AutoSize = true;
      chbxClassesAlchemist.Font = new Font("Segoe UI", 9F);
      chbxClassesAlchemist.Location = new Point(108, 47);
      chbxClassesAlchemist.Name = "chbxClassesAlchemist";
      chbxClassesAlchemist.Size = new System.Drawing.Size(79, 19);
      chbxClassesAlchemist.TabIndex = 48;
      chbxClassesAlchemist.Text = "Alchemist";
      chbxClassesAlchemist.UseVisualStyleBackColor = true;
      // 
      // chbxClassesMonster
      // 
      chbxClassesMonster.AutoSize = true;
      chbxClassesMonster.Font = new Font("Segoe UI", 9F);
      chbxClassesMonster.Location = new Point(199, 47);
      chbxClassesMonster.Name = "chbxClassesMonster";
      chbxClassesMonster.Size = new System.Drawing.Size(70, 19);
      chbxClassesMonster.TabIndex = 50;
      chbxClassesMonster.Text = "Monster";
      chbxClassesMonster.UseVisualStyleBackColor = true;
      // 
      // chbxClassesRanger
      // 
      chbxClassesRanger.AutoSize = true;
      chbxClassesRanger.Font = new Font("Segoe UI", 9F);
      chbxClassesRanger.Location = new Point(275, 22);
      chbxClassesRanger.Name = "chbxClassesRanger";
      chbxClassesRanger.Size = new System.Drawing.Size(63, 19);
      chbxClassesRanger.TabIndex = 5;
      chbxClassesRanger.Text = "Ranger";
      chbxClassesRanger.UseVisualStyleBackColor = true;
      // 
      // chbxClassesWarrior
      // 
      chbxClassesWarrior.AutoSize = true;
      chbxClassesWarrior.Font = new Font("Segoe UI", 9F);
      chbxClassesWarrior.Location = new Point(275, 72);
      chbxClassesWarrior.Name = "chbxClassesWarrior";
      chbxClassesWarrior.Size = new System.Drawing.Size(65, 19);
      chbxClassesWarrior.TabIndex = 7;
      chbxClassesWarrior.Text = "Warrior";
      chbxClassesWarrior.UseVisualStyleBackColor = true;
      // 
      // chbxClassesMage
      // 
      chbxClassesMage.AutoSize = true;
      chbxClassesMage.Font = new Font("Segoe UI", 9F);
      chbxClassesMage.Location = new Point(199, 22);
      chbxClassesMage.Name = "chbxClassesMage";
      chbxClassesMage.Size = new System.Drawing.Size(56, 19);
      chbxClassesMage.TabIndex = 47;
      chbxClassesMage.Text = "Mage";
      chbxClassesMage.UseVisualStyleBackColor = true;
      // 
      // chbxClassesAdventurer
      // 
      chbxClassesAdventurer.AutoSize = true;
      chbxClassesAdventurer.Font = new Font("Segoe UI", 9F);
      chbxClassesAdventurer.Location = new Point(108, 22);
      chbxClassesAdventurer.Name = "chbxClassesAdventurer";
      chbxClassesAdventurer.Size = new System.Drawing.Size(85, 19);
      chbxClassesAdventurer.TabIndex = 46;
      chbxClassesAdventurer.Text = "Adventurer";
      chbxClassesAdventurer.UseVisualStyleBackColor = true;
      // 
      // chbxClassesAnimal
      // 
      chbxClassesAnimal.AutoSize = true;
      chbxClassesAnimal.Font = new Font("Segoe UI", 9F);
      chbxClassesAnimal.Location = new Point(108, 72);
      chbxClassesAnimal.Name = "chbxClassesAnimal";
      chbxClassesAnimal.Size = new System.Drawing.Size(64, 19);
      chbxClassesAnimal.TabIndex = 45;
      chbxClassesAnimal.Text = "Animal";
      chbxClassesAnimal.UseVisualStyleBackColor = true;
      // 
      // chbxClassesThief
      // 
      chbxClassesThief.AutoSize = true;
      chbxClassesThief.Font = new Font("Segoe UI", 9F);
      chbxClassesThief.Location = new Point(275, 47);
      chbxClassesThief.Name = "chbxClassesThief";
      chbxClassesThief.Size = new System.Drawing.Size(52, 19);
      chbxClassesThief.TabIndex = 1;
      chbxClassesThief.Text = "Thief";
      chbxClassesThief.UseVisualStyleBackColor = true;
      // 
      // chbxClassesUnused1
      // 
      ...
      chbxClassesUnused1.Text = "Unused1";
      chbxClassesUnused1.UseVisualStyleBackColor = true;
      // 
      // chbxClassesNone
      // 
      chbxClassesNone.AutoSize = true;
      chbxClassesNone.Font = new Font("Segoe UI", 9F);
      chbxClassesNone.Location = new Point(6, 22);
      chbxClassesNone.Name = "chbxClassesNone";
      chbxClassesNone.Size = new System.Drawing.Size(55, 19);
      chbxClassesNone.TabIndex = 0;
      chbxClassesNone.Text = "None";
      chbxClassesNone.UseVisualStyleBackColor = true;
      // 
      // chbxClassesPaladin
      // 
      chbxClassesPaladin.AutoSize = true;
      chbxClassesPaladin.Font = new Font("Segoe UI", 9F);
      chbxClassesPaladin.Location = new Point(199, 97);
      chbxClassesPaladin.Name = "chbxClassesPaladin";
      chbxClassesPaladin.Size = new System.Drawing.Size(65, 19);
      chbxClassesPaladin.TabIndex = 4;
      ...
      label32.TabIndex = 68;
      label32.Text = "Used Ammunition Type";
      // 
      ...
      label30.TabIndex = 65;
      label30.Text = "Magic Attack Level";
      // 
      // nudMaxRecharges
      // 
      ...
      nudMaxRecharges.Value = new decimal(new int[] { 100, 0, 0, 0 });
      // 
      // label23
      // 
      ...
      nudEnchantPrice.Value = new decimal(new int[] { 100, 0, 0, 0 });
      // 
      // nudMagicAttackLevel
      // 
      ...
      nudMaxSpellCharges.Value = new decimal(new int[] { 100, 0, 0, 0 });
      // 
      // label24
      // 
      ...
      label18.TabIndex = 53;
      label18.Text = "Initial Spell Charges";
      // 
      // nudHands
      // 
      ...
      nudHands.TabIndex = 58;
      nudHands.Value = new decimal(new int[] { 2, 0, 0, 0 });
      // 
      // label20
      // 
      ...
      label14.TabIndex = 55;
      label14.Text = "Enchant Price";
      // 
      // grbxGraphic
      // 
      grbxGraphic.Controls.Add(chbxZoom);
      grbxGraphic.Controls.Add(nudGraphicIndex);
      ...
      Controls.Add(grbxDefaultSlotFlags);
      Controls.Add(grbxFlags);
      ...
      MinimumSize = new System.Drawing.Size(248, 268);
      Name = "EditItemForm";
      Text = "Item";
      ...
      grbxFlags.ResumeLayout(false);
      grbxFlags.PerformLayout();
      grbxDefaultSlotFlags.ResumeLayout(false);
      ...
      ((System.ComponentModel.ISupportInitialize)nudGraphicIndex).EndInit();
      grbxTexts.ResumeLayout(false);
    ...
    private ComboBox cbxAttribute;
    private ComboBox cbxSpell;
    ...
    private GroupBox grbxFlags;
    private CheckBox chbxItemFlagsAccursed;
    private CheckBox chbxItemFlagsCloneable;
    private CheckBox chbxItemFlagsNotImportant;
    private CheckBox chbxItemFlagsNone;
    private CheckBox chbxItemFlagsStackable;
    private CheckBox chbxItemFlagsDestroyAfterUsage;
    private CheckBox chbxItemFlagsIndestructible;
    private CheckBox chbxItemFlagsRemovableDuringFight;
    private ComboBox cbxAmmunitionType;
    private Label label7;
    private GroupBox grbxDefaultSlotFlags;
    private CheckBox chbxDefaultSlotFlagIdentified;
    private CheckBox chbxDefaultSlotFlagLocked;
    ...
    private CheckBox chbxClassesRanger;
    private CheckBox chbxClassesPaladin;
    private CheckBox chbxClassesThief;
    private CheckBox chbxClassesNone;
    private CheckBox chbxClassesHealer;
    private CheckBox chbxClassesMonster;
    private CheckBox chbxClassesAlchemist;
    private CheckBox chbxClassesMage;
    ...
    private NumericUpDown nudGraphicIndex;
    private CheckBox chbxZoom;
    private Label label8;
    private NumericUpDown nudWeight;
    private NumericUpDown nudAttribute;
    private ComboBox cbxSkill;
    private NumericUpDown nudSkill;
    private Label label27;
    private ComboBox cbxPenaltySkill2;
    private NumericUpDown nudPenaltySkill2;
    private Label label22;
    private ComboBox cbxPenaltySkill1;
    private NumericUpDown nudPenaltySkill1;
    private Label label21;
    private Label label28;
    private NumericUpDown nudDamage;
    private Label label12;
    private NumericUpDown nudHitPoints;
    private Label label13;
    private NumericUpDown nudDefense;
    private Label label14;
    private NumericUpDown nudEnchantPrice;
    private Label label15;
    private NumericUpDown nudBreakChance;
    private Label label16;
    private NumericUpDown nudSpellPoints;
    private Label label17;
    private NumericUpDown nudInitialRecharges;
    private Label label18;
    private NumericUpDown nudInitialSpellCharges;
    private Label label19;
    private NumericUpDown nudMaxRecharges;
    private Label label20;
    private NumericUpDown nudMaxSpellCharges;
    private Label label23;
    private NumericUpDown nudFingers;
    private Label label24;
    private NumericUpDown nudHands;
    private ComboBox cbxEquipmentSlot;
    private Label label25;
    private Label label26;
    private NumericUpDown nudMagicDefenseLevel;
    private Label label30;
    private NumericUpDown nudMagicAttackLevel;
    private ComboBox cbxSpecialPurpose;
    private Label label31;
    private Label label32;
    private ComboBox cbxUsedAmmunition;
    private Label label33;
    private ComboBox cbxTransportation;
    private GroupBox grbxTexts;
    private Label label6;
    private NumericUpDown nudTextSub;
    private Label label10;
    private NumericUpDown nudText;
    private CheckBox chbxClassesAll;
    private CheckBox chbxClassesUnused2;
