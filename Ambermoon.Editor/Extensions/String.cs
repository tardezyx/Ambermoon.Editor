...
namespace Ambermoon.Editor.Extensions {
  internal static partial class Extensions {
    #region --- fields ----------------------------------------------------------------------------
    [GeneratedRegex(@"\w\w")]
    private static partial Regex RegexTwoWords();
    [GeneratedRegex(@"(?<!^)(?=[A-Z])")]
    private static partial Regex RegexUpperLetters();
    #endregion
    ...
    internal static string[] GetSplitCamelCase(string? source) {
      ...
      return RegexUpperLetters().Split(source);
    }
    #endregion
    ...
    internal static string GetValidFileName(this string? source, char? replacement = '_', bool fancy = true) {
      ...
      StringBuilder stringBuilder = new(source.Length);
    ...
    internal static string GetValueFromHexString(this string? source) {
      ...
      string result = string.Empty;
      MatchCollection matchCollection = RegexTwoWords().Matches(source);
